...
class ModelValidationTests(unittest.TestCase):
    def test_cli_catalog_models_are_all_validator_approved(self):
        for provider, models in get_known_models().items():
            if provider in ("ollama", "openrouter", "siliconflow"):
                continue
    ...
    def test_openrouter_ollama_and_siliconflow_accept_custom_models_without_warning(self):
        for provider in ("openrouter", "ollama", "siliconflow"):
